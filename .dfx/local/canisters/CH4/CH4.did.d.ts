...
export interface Sell {
  ...
  'cancelSell' : (arg_0: CancelArgs) => Promise<Result_2>,
  ...
  'listSell' : (arg_0: ListArgs) => Promise<Result_2>,
  'updateBuyPrice' : (arg_0: UpdateArgs) => Promise<Result_1>,
